...
namespace WindowsFormsApplication18
{
    public abstract class Vehicle : ITransport
    {
        ...
        protected int countСapacitys;
        public virtual int MaxCountPassengers { protected set; get; }
        public virtual int MaxCountСapacitys { protected set; get; }
        ...
        {
            if (countСapacitys + count < MaxCountСapacitys)
            {
                countСapacitys += count;
            }
        }
        public int getСapacity()
        {
            int count = countСapacitys;
            countСapacitys = 0;
            return count;
        }
